      ...
      fetch(path)
        ...
        .then((data) => {
          ...
          const features = data.map((item, idx) => ({
            details: categoryByParcel?.find(
              (cat) => cat.PARCEL_LID === item.properties.id
            ),
            ...item,
            mainCategory: categoryByParcel?.find(
              (cat) => cat.PARCEL_LID === item.properties.id
            )?.ZONING_CATEGORY,
            properties: {
              ...item.properties,
                    ...
                    filteredParcelData.some(
                      ...
                      >
                        <div
                          ...
                          style={{
                            backgroundColor: getColor(parcel?.mainCategory)
                              ?.background,
                            color: getColor(parcel?.mainCategory)?.text,
                            display: "flex",
                            alignItems: "center",
